...
public class Main {
    public static void main(String[] args) {
        ...
        org.example.UserService userService = new UserService();

        // Creating a new User
        org.example.User newUser = new User("JohnDoe", "password", "johndoe@example.com");
        ...
        // Logging in the user
        org.example.User loggedInUser = userService.loginUser("JohnDoe", "password");
        ...
        org.example.BookService bookService = new BookService();
